...
각 노트북의 첫 번째 코드 셀에서 필요한 패키지를 자동 설치합니다.

```bash
# 로컬 실행 시
pip install fairlearn shap mlflow diffprivlib alibi alibi-detect evidently
```

## 라이선스

MIT License — 교육 및 연구 목적의 자유로운 활용을 허가합니다.
